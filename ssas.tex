...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}{5cm}
      \begin{center}
        \href{https://youtu.be/e7LcmWiclOs}{\includegraphics[width=\columnwidth]{GW170817-rendition}}
      \end{center}
    \end{column}
    \begin{column}{7cm}
...
\begin{frame}
  \frametitle{Simulating the disk of stuff}
  \begin{center}
...
\begin{frame}
  \frametitle{We Need Big Computers!}
  \begin{center}
    \includegraphics[height=6cm]{trinity-supercomputer}
  \end{center}
\end{frame}
